...
describe('Book Store app', () => {
  ...
  it('Should be possible to search for a book and add to the collection', () => {
    ...
    cy.get('.profile-wrapper')
      ...
      .and('contain', 'Like it or not, JavaScript is everywhere these days-from browser to server');
